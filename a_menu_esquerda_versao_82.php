<nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    ...
                                    <div class="user-details">
                                        <span>Marcos</span>
                                        <span id="more-details">Programador<i class="ti-angle-down"></i></span>
                                    </div>
                                </div>
                                ...
                                <div class="main-menu-content">
                                    <ul>
                                        <li class="more-details">
                                            ...
                                            <a href="#!"><i class="ti-settings"></i>Configuraç~poes</a>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                               <li class="">
                                    <a href="index.php?pg=graficos1">
                                        <span class="pcoded-micon"><i class="ti-home"></i><b>D</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Graficos 1</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="">
                                 <a href="index.php?pg=graficos2">
                                        <span class="pcoded-micon"><i class="ti-home"></i><b>D</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Graficos 2</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="">
